 ...
 * Media
 *
 * @ORM\Table("spectacleimage")
 * @ORM\Entity(repositoryClass="CP\CPBundle\Repository\SpectacleImageRepository")
 * @ORM\HasLifecycleCallbacks
 */
class SpectacleImage
{
    private $temp;
    /**
     * @var integer
    ...
    /**
     * @ORM\ManyToOne(targetEntity="CP\CPBundle\Entity\Spectacle", inversedBy="spectacleimages")
