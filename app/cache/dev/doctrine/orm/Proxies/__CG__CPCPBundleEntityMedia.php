...
namespace Proxies\__CG__\CP\CPBundle\Entity;

/**
 * DO NOT EDIT THIS FILE - IT WAS CREATED BY DOCTRINE'S PROXY GENERATOR
 */
class Media extends \CP\CPBundle\Entity\Media implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'CP\\CPBundle\\Entity\\Media' . "\0" . 'temp', '' . "\0" . 'CP\\CPBundle\\Entity\\Media' . "\0" . 'id', '' . "\0" . 'CP\\CPBundle\\Entity\\Media' . "\0" . 'updateAt', '' . "\0" . 'CP\\CPBundle\\Entity\\Media' . "\0" . 'path', 'file');
        }
