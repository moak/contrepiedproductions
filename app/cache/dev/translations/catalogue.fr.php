...
',
    ...
    'fos.create_clan' => 'Créer un clan',
    'fos.join_clan' => 'Rejoindre un clan',
    'fos.register' => 'Inscription',
    'fos.stay_connected' => 'Se rappeler de moi',
  ),
  ...
  array (
    'views.layout.bannersadmin' => 'Administrateur',
    'views.index.filters' => 'Filtres',
    'views.index.filter' => 'Filtrer',
    'views.index.reset' => 'Réinitialiser',
    'views.index.list' => 'Liste %entity%',
    'views.index.actions' => 'Actions',
    'views.index.createnew' => 'Créer un nouveau',
    'views.index.pagprev' => '&larr; Précédent',
    'views.index.pagnext' => 'Suivant &rarr;',
    'views.actions.show' => 'afficher',
    'views.actions.edit' => 'editer',
    'views.recordactions.backtothelist' => 'Retour à la liste',
    'views.recordactions.edit' => 'Editer',
    'views.recordactions.delete' => 'Supprimer',
    'views.recordactions.confirm' => 'Supprimer l\'élément ?',
    'views.new.creation' => 'Créer %entity%',
    'views.new.create' => 'Créer',
    'views.edit.edit' => 'Editer %entity%',
    'views.edit.editbutton' => 'Editer',
    'views.show.show' => 'Voir %entity%',
    'flash.create.success' => 'L\'élément a été créé.',
    'flash.create.error' => 'Une erreur est survenue lors de la création de l\'élément.',
    'flash.update.success' => 'L\'élément a été mis à jour.',
    'flash.update.error' => 'Une erreur est survenue lors de la mise à jour de l\'élément.',
    'flash.delete.success' => 'L\'élément a été supprimé.',
    'flash.delete.error' => 'Une erreur est survenue lors de la suppression de l\'élément.',
  ),
));
...
',
    ...
    'fos.create_clan' => 'Create a clan',
    'fos.join_clan' => 'Join a clan',
    'fos.register' => 'Registration',
    'fos.stay_connected' => 'Remember me',
  ),
  'LexikFormFilterBundle' => 
  array (
